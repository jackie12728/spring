...
public class UserService {
	...
	// 變更密碼
	public void updatePassword(Integer userId, String username, String oldPassword, String newPassword) throws UserNotFoundException, PasswordExpiredException {
		User user = userDao.getUser(username);
		if(user == null) {
		...
		if(!oldPasswordHash.equals(user.getPasswordHash())) {
			throw new PasswordExpiredException("原密碼輸入錯誤");
		}
